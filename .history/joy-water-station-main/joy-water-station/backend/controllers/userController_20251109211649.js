...
// Get all users (admin only) - Shows all users including admins with formatted dates and login count
exports.getAllUsers = async (req, res) => {
  try {
    // Get all users that are not hidden, with formatted timestamps and login count
    const [users] = await db.promise().query(
      `SELECT
        u.id,
        u.username,
