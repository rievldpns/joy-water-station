...
export default function SalesManagement({
  ...
  // Always fetch sales from API and listen for updates
  useEffect(() => {
    let mounted = true;
    const loadSales = async () => {
      try {
        ...
        pushToast('error', 'Failed to load sales data');
      }
    };
    loadSales();
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button onClick={openAddModal} disabled={loading} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center gap-2 font-medium shadow">
            <Plus className="w-4 h-4" /> New Sale
          </button>
          <button onClick={exportAllCSV} disabled={loading} className="bg-white border border-gray-300 px-3 py-2 rounded-lg hover:bg-gray-50 disabled:bg-gray-100 disabled:cursor-not-allowed flex items-center gap-2 font-medium shadow">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 sticky top-0 bg-white z-10 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button onClick={closeModal} disabled={loading} className="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed font-medium">Cancel</button>
                <button onClick={saveSale} disabled={loading} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center gap-2 font-medium">
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  }} disabled={loading} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={formData.transactionType} onChange={(e) => setFormData({ ...formData, transactionType: e.target.value })} disabled={loading} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed">
                    ...
                    return (
                      <div key={idx} className="grid grid-cols-[2fr_1fr_1fr_40px] gap-2 items-end">
                        <div>
                          ...
                          <select value={it.itemId} onChange={(e) => updateItemRow(idx, 'itemId', e.target.value)} disabled={loading} className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white disabled:bg-gray-100 disabled:cursor-not-allowed">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            value={it.price}
                            readOnly
                            className="w-full px-3 py-2 border border-gray-300 rounded text-right bg-gray-100"
                          />
                        </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input type="number" min="0" step="0.01" value={formData.discount} onChange={(e) => setFormData({ ...formData, discount: parseFloat(e.target.value || 0) })} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="0.00" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea value={formData.notes} onChange={(e) => setFormData({ ...formData, notes: e.target.value })} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none" rows="3" placeholder="Add any notes about this sale..." />
              </div>
