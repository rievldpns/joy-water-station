...
export default function UserManagement({ users, setUsers, currentUser, setCurrentView }) {
  ...
  // Users are passed as props, no need to fetch from API
  // The App component manages the users state

  // Function to fetch all users from API (kept for refresh functionality)
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      {/* Debug info */}
      <div className="bg-gray-100 border border-gray-300 px-4 py-3 rounded mb-4 text-sm">
        <strong>Debug Info:</strong> Total users in state: {users.length} | Filtered: {filteredUsers.length} | Current User: {currentUser?.username || 'None'}
      </div>
