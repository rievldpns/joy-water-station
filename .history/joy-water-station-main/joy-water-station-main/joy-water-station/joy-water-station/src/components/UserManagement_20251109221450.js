...
function UserManagement({ users, setUsers, currentUser, setCurrentView }) {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      // Fetch all users (everyone can view the user list)
          ...
          <thead className="bg-gray-100">
            <tr>
              ...
              <th
                ...
                className="w-28 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200 hidden md:table-cell transition-colors"
              >
                <div className="flex items-center gap-1">
                  Created
                  {sortField === 'createdAt' && (
              ...
              <th
                ...
                className="w-20 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200 hidden md:table-cell transition-colors"
              >
                <div className="flex items-center gap-1">
                  Logins
              ...
              <th
                ...
                className="w-28 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200 hidden lg:table-cell transition-colors"
              >
                <div className="flex items-center gap-1">
                  Last Login
                  {sortField === 'lastLogin' && (
                  ...
                  <tr key={user.id} className={`${editingUserId === user.id || changingPasswordUserId === user.id ? 'bg-yellow-50' : 'hover:bg-gray-50'} transition-colors`}>
                    {editingUserId === user.id ? (
                      <>
                        ...
                        <td className="px-3 py-2 hidden md:table-cell text-sm">{formData.createdAt}</td>
                        <td className="px-3 py-2 hidden md:table-cell text-sm">{loginCount}</td>
                        <td className="px-3 py-2 hidden lg:table-cell text-sm">{formData.lastLogin || 'N/A'}</td>
                        <td className="px-3 py-2">
                      ...
                      <>
                        ...
                        <td className="px-3 py-2 hidden md:table-cell text-sm font-medium">{loginCount}</td>
                        ...
                        <td className="px-3 py-2">
                          <div className="flex gap-1 flex-wrap">
                            ...
                            {/* Block and Hide buttons - only for admins managing other non-admin users */}
