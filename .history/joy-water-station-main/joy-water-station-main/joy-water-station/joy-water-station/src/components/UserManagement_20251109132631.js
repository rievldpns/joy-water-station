...
const UserManagement = React.memo(function UserManagement({ users, setUsers, currentUser, setCurrentView }) {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      // Fetch all users (including those who haven't logged in)
  ...
  // Memoize summary statistics to prevent unnecessary recalculations
  const totalUsers = users.length;
  const activeUsers = useMemo(() => users.filter(u => !u.isBlocked).length, [users]);
  const blockedUsers = useMemo(() => users.filter(user => user.isBlocked).length, [users]);
  const adminUsers = useMemo(() => users.filter(u => u.role === 'Administrator').length, [users]);
          ...
          <thead className="bg-gray-100">
            <tr>
              <th
                ...
                className="w-24 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200"
              >
              ...
              <th
                ...
                className="w-32 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200"
              >
                <div className="flex items-center gap-1">
                  Email
                  {sortField === 'email' ? (
              ...
              <th
                ...
                className="w-20 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200"
              >
                <div className="flex items-center gap-1">
                  First Name
                  {sortField === 'firstName' ? (
              ...
              <th
                ...
                className="w-16 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200"
              >
                <div className="flex items-center gap-1">
                  Status
                  {sortField === 'isBlocked' ? (
              ...
              <th
                ...
                className="w-24 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200 hidden md:table-cell"
              >
                <div className="flex items-center gap-1">
                  Created
                  {sortField === 'createdAt' ? (
              ...
              <th
                ...
                className="w-24 px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase cursor-pointer select-none hover:bg-gray-200 hidden lg:table-cell"
              >
                <div className="flex items-center gap-1">
                  Last Login
                  {sortField === 'lastLogin' ? (
                    ...
                    <>
                      ...
                      <td className="px-3 py-2">
                        <div className="flex gap-1">
                          <button
                            onClick={saveEdit}
                            className="bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded flex items-center gap-1 text-xs"
                          >
                          ...
                          <button
                            onClick={cancelEdit}
                            className="bg-gray-500 hover:bg-gray-600 text-white px-2 py-1 rounded flex items-center gap-1 text-xs"
                          >
                            <X className="w-3 h-3" />
                            Cancel
                          </button>
                          ...
                          {user.id === currentUser?.id && (
                            <>
                              <button
                                ...
                                className="bg-yellow-400 hover:bg-yellow-500 text-white px-2 py-1 rounded flex items-center gap-1 text-xs mb-1"
                                title="Edit User"
                              >
                              ...
                              <button
                                ...
                                className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded flex items-center gap-1 text-xs mb-1"
                          ...
                          {currentUser?.role === 'Administrator' && user.role !== 'Administrator' && user.id !== currentUser.id && (
                            <>
                              <button
                                ...
                                className={user.isBlocked ? 'bg-green-500 hover:bg-green-600 text-white px-2 py-1 rounded flex items-center gap-1 text-xs mb-1' : 'bg-red-500 hover:bg-red-600 text-white px-2 py-1 rounded flex items-center gap-1 text-xs mb-1'}
                              ...
                              <button
                                ...
                                className="bg-orange-500 hover:bg-orange-600 text-white px-2 py-1 rounded flex items-center gap-1 text-xs mb-1"
                                title="Hide User"
                              >
