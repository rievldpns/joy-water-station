                    ...
                    return (
                      <div key={idx} className="grid grid-cols-[2fr_1fr_1fr_40px] gap-2 items-end">
                        <div>
                          ...
                          <select value={it.itemId} onChange={(e) => updateItemRow(idx, 'itemId', e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white">
