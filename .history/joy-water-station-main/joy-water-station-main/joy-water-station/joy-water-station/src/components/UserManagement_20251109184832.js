                          ...
                          {user.id === currentUser?.id && (
                            <>
                              <button
                                ...
                                className="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-2 rounded flex items-center gap-2 text-sm transition-colors"
                                title="Edit User"
                              >
                              ...
                              <button
                                ...
                                className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded flex items-center gap-2 text-sm transition-colors"
                          ...
                          {currentUser?.role === 'Administrator' && user.role !== 'Administrator' && user.id !== currentUser.id && (
                            <>
                              <button
                                ...
                                className={`${user.isBlocked ? 'bg-green-500 hover:bg-green-600' : 'bg-red-500 hover:bg-red-600'} text-white px-3 py-2 rounded flex items-center gap-2 text-sm transition-colors`}
                              ...
                              <button
                                ...
                                className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 rounded flex items-center gap-2 text-sm transition-colors"
                                title="Hide User"
                              >
