  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-gray-100 border border-gray-300 px-4 py-3 rounded mb-4 text-sm">
        <strong>Debug Info:</strong> Total users in state: {users.length} | Filtered: {filteredUsers.length} | Displayed: {Math.min(sortedUsers.length, 5)} | Current User: {currentUser?.username || 'None'}
      </div>
