...
export default function UserManagement({ users, setUsers, currentUser, setCurrentView }) {
  ...
  // Fetch users on component mount - FIXED: Only runs once
  useEffect(() => {
  ...
  // Function to fetch all users from API - FIXED: Changed endpoint to /all
  const fetchUsers = async () => {
    ...
    try {
      ...
      // FIXED: Changed to '/logged-in' to get only users who have logged in
