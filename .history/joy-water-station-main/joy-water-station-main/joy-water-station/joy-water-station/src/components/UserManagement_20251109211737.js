...
function UserManagement({ users, setUsers, currentUser, setCurrentView }) {
  ...
  const saveChangePassword = async () => {
    ...
    if (containsPersonalInfo) {
      alert('Password should not contain personal information such as username, email, or name');
      return;
    }
                ...
                return (
                  ...
                  {editingUserId === user.id ? (
                    <>
                      ...
                      <td className="px-3 py-2 hidden md:table-cell">{formData.loginCount || 0}</td>
                    ...
                    <>
                      ...
                      <td className="px-3 py-2 hidden md:table-cell text-sm">{user.loginCount || 0}</td>
