    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button onClick={openAddModal} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2 font-medium shadow" disabled={loading}>
            <Plus className="w-4 h-4" /> New Sale {loading && '(Loading...)'}
          </button>
          <button onClick={() => console.log('Test button clicked')} className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 flex items-center gap-2 font-medium shadow">
            Test Click
          </button>
