...
export default function UserManagementSystem() {
  ...
  const Layout = ({ title, children }) => (
    <div className="min-h-screen bg-gray-50 flex">
      <Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} currentView={currentView} setCurrentView={setCurrentView} currentUser={currentUser} handleLogout={handleLogout} />
  ...
  if (currentView === 'items') {
    return (
      <Layout title="Item Management">
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <ItemManagement items={items} setItems={setItems} />
        </main>
      </Layout>
    );
  }
...
if (currentView === 'sales') {
  return (
    <Layout title="Sales Management">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <SalesManagement sales={sales} setSales={setSales} customers={customers} items={items} setItems={setItems} products={products} setProducts={setProducts} deliveries={deliveries} setDeliveries={setDeliveries} />
      </main>
    </Layout>
  );
}
